...

{
	...
	parties: [
		...
		{name: "VNL", position: "pro", explanation: "Burgers moeten meer inspraak krijgen bij politieke besluitvorming. Wij zijn voor een bindend referendum zodat de regering de uitslag niet naast zich neer kan leggen, zoals gebeurde bij het referendum over de Europese Grondwet in 2005 en het OekraÃ¯ne-referendum van vorig jaar."},
		...
		{name: "Forum voor Democratie", position: "pro", explanation: "Dit is de enige manier om politici te dwingen om naar de bevolking te luisteren. Niet-bindende referenda worden niet serieus genomen, zie referenda over EU Grondwet en Associatieverdrag OekraÃ¯ne."},
...
},
{
	...
	{name: "50Plus", position: "pro", explanation: "50PLUS vindt dat alle vormen van discriminatie hoog op de agenda moeten staan. Discriminatie op de arbeidsmarkt - op welke grond dan ook - moet teruggedrongen worden. Anoniem solliciteren kan daarbij helpen; solliciteren zonder vermelding van de leeftijd bijvoorbeeld Ã³Ã³k."},
...
for (i = 0; i < 3) {
	console.log(subject[0.statement]);
}
...
function question1() {
	...
	document.getElementById('title').innerHTML = '1. Bindend referendum';
	document.getElementById('subject').innerHTML = 'Er moet een bindend referendum komen, waarmee burgers door het parlement aangenomen wetten kunnen tegenhouden.';
	...
	option0.onclick = question0;
	option1.onclick = question2;
	option2.onclick = question2;
	option3.onclick = question2;
	option4.onclick = question2;
}

function question2() {
	console.log("question2()");
	document.getElementById('title').innerHTML = '2. Maatschappelijke dienstplicht';
	document.getElementById('subject').innerHTML = 'Er moet een maatschappelijke dienstplicht voor jongeren komen. Zij kunnen dan dienen in het leger, bij de politie of in de zorg.';
	...
	option0.onclick = question1;
	option1.onclick = question3;
	option2.onclick = question3;
	option3.onclick = question3;
	option4.onclick = question3;
}

function question3() {
	console.log("question3()");
	document.getElementById('title').innerHTML = '3. Anoniem solliciteren';
	document.getElementById('subject').innerHTML = 'Om discriminatie op basis van de naam te voorkomen, moet anoniem solliciteren bij de overheid en bij openbare instellingen de regel worden.';
	...
	option0.onclick = question2;
	option1.onclick = question4;
	option2.onclick = question4;
	option3.onclick = question4;
	option4.onclick = question4;
}

function question4() {
	console.log("question4()");
	document.getElementById('title').innerHTML = '4. Groepsbelediging';
	document.getElementById('subject').innerHTML = 'Belediging van groepen op grond van ras, godsdienst of geaardheid moet niet langer strafbaar zijn.';
	...
	option0.onclick = question3;
	option1.onclick = question5;
	option2.onclick = question5;
	option3.onclick = question5;
	option4.onclick = question5;
}